  ...
  <transition-group name="ntf" tag="div" mode="out"  >
      <div v-for="item in items" :key="item.id"  :class="'notification notification-'+item.options.type" @click="removeItem(item.id)">
         <div class="notification-message">
            ...
            <div class="message" v-if="item.message" v-html="item.message + errorContent(item)"/>
          </div>
      </div>
  </transition-group>
</div>
...
data () {
  return {
    ...
    lineFeed: '<br />',
    // center: '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;',
    okButton: '</button><button class="btn btn-danger" style="margin-top: 1rem; margin-left: 6rem;">OK</button>',
    items: [],
    idx: 0
  }
},
methods: {
  errorContent(item) {
    if(item.options.type !== 'error') {
      return '';
    }

    return this.lineFeed + this.okButton;
  },
  createUUID () {
